...
public class APC_Login_with_Password_Journey_BG8127 {
	...
	@Test(priority=7,description = " login With Password APC Advisor channel BG8127 ")
	...
	public void Login_With_Password_APC_advisor () throws IOException, InterruptedException {
		...
		FileInputStream fs = new FileInputStream("D:\\ABSLI\\ABSLI_Service_buddy\\src\\main\\java\\DemoData\\Project_Login_data.xlsx");
				...
				muser = sheet.getRow(3).getCell(1);
				mpass = sheet.getRow(3).getCell(3);
	...
	@Test(priority=8,description = "verify the dashboard page in APC Advisor channel ")
	...
	@Test(priority=9,description = " login With Password APC Advisor Channel & click on Logout button  ")
	...
	@Severity(SeverityLevel.CRITICAL)
		public void logout_with_Password_APC_Advisor_Verify_the_Welcome_to_Service_Buddy_LinkText() throws IOException, InterruptedException {
			...
			driver.findElement(By.xpath(prop.getProperty("Skip"))).click();
			Thread.sleep(2000);
			driver.findElement(By.xpath(prop.getProperty("profileLogo"))).click();
			Thread.sleep(2000);
