...
public class APC_Login_with_OTP_Journey_BG8127 {
	...
	@Test(priority=10,description = " login With OTP APC Advisor BG8127 ")
	...
	public void Login_WithOTP_APC_advisor () throws IOException, InterruptedException {
	...
	@Test(priority=11,description = " login With OTP APC Advisor portal verify the Dashboadr page ")
	...
	public void APC_Advisor_Dashboard() throws IOException, InterruptedException {
		System.setProperty("webdriver.chrome.driver", "D:\\ABSLI\\ABSLI_Service_buddy\\Driver\\chromedriver.exe");
		FileInputStream ip = new FileInputStream("D:\\ABSLI\\ABSLI_Service_buddy\\src\\main\\java\\DemoProperties\\AB.Login_Properties");
		FileInputStream fs = new FileInputStream("D:\\ABSLI\\ABSLI_Service_buddy\\src\\main\\java\\DemoData\\Project_Login_data.xlsx");
				//Creating a workbook
	...
	@Test(priority=12,description = " login With OTP APC Advisor portal click on logout button  ")
	...
	@Story("OTP Login")
	@Severity(SeverityLevel.CRITICAL)
		public void logout_with_APC_Advisor() throws IOException, InterruptedException {
