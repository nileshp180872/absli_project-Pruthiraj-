...
public class DSF_Login_withOTP_Journey_660281 {
	...
	@Test(priority=0,description = " login With OTP DSF Advisor ")
	...
	public void Login_WithOTP_DSF_advisor () throws IOException, InterruptedException {
	...
	@Test(priority=02,description = " login With OTP DSF Advisor portal verify the Dashboadr page ")
	...
	public void DSF_Advisor_Dashboard() throws IOException, InterruptedException {
		System.setProperty("webdriver.chrome.driver", "D:\\ABSLI\\ABSLI_Service_buddy\\Driver\\chromedriver.exe");
		FileInputStream ip = new FileInputStream("D:\\ABSLI\\ABSLI_Service_buddy\\src\\main\\java\\DemoProperties\\AB.Login_Properties");
		FileInputStream fs = new FileInputStream("D:\\ABSLI\\ABSLI_Service_buddy\\src\\main\\java\\DemoData\\Project_Login_data.xlsx");
				//Creating a workbook
	...
	@Test(priority=01,description = " login With OTP DSF Advisor portal click on logout button  ")
	...
	@Story("OTP Login")
	@Severity(SeverityLevel.CRITICAL)
		public void logout_with_DSF_Advisor() throws IOException, InterruptedException {
