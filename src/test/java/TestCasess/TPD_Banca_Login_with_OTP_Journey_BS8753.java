...
public class TPD_Banca_Login_with_OTP_Journey_BS8753 {
	...
	@Test(priority=19,description = " login With OTP TPD_Banca Advisor BS8753 ")
	...
	public void Login_WithOTP_TPD_Banca_advisor () throws IOException, InterruptedException {
	...
	@Test(priority=20,description = " login With OTP TPD_Banca Advisor portal verify the Dashboadr page ")
	...
	public void TPD_Banca_Dashboard() throws IOException, InterruptedException {
		System.setProperty("webdriver.chrome.driver", "D:\\ABSLI\\ABSLI_Service_buddy\\Driver\\chromedriver.exe");
		FileInputStream ip = new FileInputStream("D:\\ABSLI\\ABSLI_Service_buddy\\src\\main\\java\\DemoProperties\\AB.Login_Properties");
		FileInputStream fs = new FileInputStream("D:\\ABSLI\\ABSLI_Service_buddy\\src\\main\\java\\DemoData\\Project_Login_data.xlsx");
				//Creating a workbook
	...
	@Test(priority=21,description = " login With OTP TPD_Banca portal click on logout button  ")
	...
	@Severity(SeverityLevel.MINOR)
		public void logout_with_TPD_Banca_Advisor() throws IOException, InterruptedException {
